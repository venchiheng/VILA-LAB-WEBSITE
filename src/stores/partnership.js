...
export const usePartnershipStore = defineStore('partnership', () => {
    ...
    async function fetchPartnerships() {
        try {
            const res = await axios.get('http://44.223.137.10:8000/api/partnerships')
    ...
    async function createPartnership() {
        ...
        try {
            ...
            const res = await axios.post(
                'http://44.223.137.10:8000/api/partnerships',
                form,
    ...
    async function updatePartnership(id, payload) {
        ...
        try {
            ...
            await axios.post(`http://44.223.137.10:8000/api/partnerships/${id}`, form)
    ...
    async function deletePartnership(id) {
        ...
        try {
            await axios.delete(`http://44.223.137.10:8000/api/partnerships/${id}`)
