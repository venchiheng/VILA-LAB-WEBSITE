  ...
  <div class="wrapper">
    ...
    <div class="details">
      ...
      <div class="chips-list">
        <v-chip-group>
          <v-chip :style="{ backgroundColor: statusColor, color: '#fff', padding: '12px 24px' }" variant="flat">
            {{ equipment.status }}
          </v-chip>
      ...
      <div class="policy">
        ...
        <ul>
          ...
          <li>Borrowers must record their name, item, date, and expected return time in the equipment booking system.</li>
          <li>Equipment must be handled responsibly and used only for academic or project-related purposes.</li>
          <li>Borrowers are fully responsible for any damage, loss, or malfunction occurring during the borrowing period.</li>
          <li>All items must be returned on time and in the same condition. Late returns may affect future borrowing privileges.</li>
