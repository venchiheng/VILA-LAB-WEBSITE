...
export const useContactMessageStore = defineStore('contactMessage', {
    ...
    actions: {
        async postMessage(data) {
            try {
                const response = await axios.post('http://44.223.137.10:8000/api/contact-messages', {
        ...
        async fetchMessages() {
            try {
                const response = await axios.get('http://44.223.137.10:8000/api/contact-messages')
