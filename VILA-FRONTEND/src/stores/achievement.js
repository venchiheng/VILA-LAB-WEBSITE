...
export const useAchievementStore = defineStore('achievement', () => {
  ...
  async function createAchievement() {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:8000/api/achievements', form, {
  ...
  async function updateAchievement(id, payload) {
    ...
    try {
      ...
      const res = await axios.post(`http://localhost:8000/api/achievements/${id}`, form, {
        headers: { 'Content-Type': 'multipart/form-data' },
      })
  ...
  async function deleteAchievement(id) {
    ...
    try {
      await axios.delete(`http://localhost:8000/api/achievements/${id}`)
